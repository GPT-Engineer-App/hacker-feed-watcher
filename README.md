...
**Project**: hacker-feed-watcher 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Can you read and show in realtime new post and comments from this hacker news rss
...
```sh
git clone https://github.com/GPT-Engineer-App/hacker-feed-watcher.git
cd hacker-feed-watcher
npm i
